...
var BaseNotification_1 = require("./BaseNotification");
...
var BaseController = /** @class */ (function (_super) {
    ...
    BaseController.prototype.all = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._repository.find({ where: { deleted: false, createBy: request.userAuth.uid } })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    BaseController.prototype.one = function (request) {
        var _uid = request.params.uid;
        return this._repository.findOne(_uid);
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._repository.findOne(model.uid)];
                    case 1:
                        _modelInDB = _a.sent();
                        if (_modelInDB) {
...
}(BaseNotification_1.BaseNotification));
