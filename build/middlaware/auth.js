...
exports.default = (function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
    var token, publicRoutes, isPublicRoute, _userAuth;
    return __generator(this, function (_a) {
        token = request.body.token || request.query.token || request.headers['x-token-access'];
        publicRoutes = config_1.default.publicRoutes;
        isPublicRoute = false;
        publicRoutes.forEach(function (url) {
            var isPublic = request.url.includes(url);
            if (isPublic) {
                isPublicRoute = true;
            }
        });
        if (isPublicRoute) {
            ...
            if (token) {
                try {
                    ...
                    request._userAuth = _userAuth;
                    console.log('Entrou?', request._userAuth);
                    next();
                }
                catch (error) {
